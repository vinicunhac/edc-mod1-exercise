...
resource "aws_iam_policy" "lambda" {
  name        = "XPAWSLambdaBasicExecutionRolePolicy"
  path        = "/"
  ...
  policy = <<EOF
{
    ...
    "Statement": [
        ...
        {
          "Action": "iam:PassRole",
          "Resource": ["arn:aws:iam::386835512844:role/EMR_DefaultRole",
                       "arn:aws:iam::386835512844:role/EMR_EC2_DefaultRole"],
          "Effect": "Allow"
        }
    ]
}
